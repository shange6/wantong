...
<template>
  <div class="app-container">
    ...
    <div class="search-container">
      ...
      >
        <el-form-item prop="status" label="项目">
          <el-select
    ...
    <el-card class="data-table">
      ...
      >
        ...
        <el-table-column label="万通码" prop="wtcode" min-width="120" show-overflow-tooltip></el-table-column>
        <el-table-column label="代号" prop="code" min-width="120" show-overflow-tooltip></el-table-column>
        <el-table-column label="名称" prop="name" min-width="150" show-overflow-tooltip></el-table-column>
        <el-table-column label="数量" prop="count" align="center" min-width="80"></el-table-column>
        <el-table-column label="单重" prop="unit_mass" align="center" min-width="80"></el-table-column>
        <el-table-column label="总重" prop="total_mass" align="center" min-width="80"></el-table-column>
        <el-table-column label="备注" prop="remark" align="center" min-width="80"></el-table-column>
