  ...
  try {
    ...
    const payload = {
      ...
      project_info: {
        ...
        projectCode: uploadResult.componentCode.substring(0, uploadResult.componentCode.lastIndexOf('.')),
        contractNo: uploadResult.contractNo,
      },
      component_info: {
        parentCode: uploadResult.componentCode.substring(0, uploadResult.componentCode.lastIndexOf('.')),
        componentName: uploadResult.componentName,
        componentCode: uploadResult.componentCode,
    ...
    // 3. 提交
    await DataAPI.saveData(payload);
