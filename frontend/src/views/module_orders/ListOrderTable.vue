  ...
  <div v-loading="loading" class="list-order-table">
    ...
    >
      <template #append-columns>
        <el-table-column label="代号" prop="components_code" min-width="150" show-overflow-tooltip />
        <el-table-column label="名称" prop="components_spec" min-width="120" show-overflow-tooltip />
        <el-table-column label="数量" prop="components_count" min-width="40" align="center" />        
...
import OrdersAPI, { type OrdersData, type OrdersFilter } from "@/api/module_orders/order";
